            ...
            <div className="flex flex-col justify-center max-w-xs my-8 mx-auto bg-white shadow-xl rounded-xl p-5 dark:bg-gray-900">
                ...
                <div className="text-center mt-5">
                    ...
                    <div className="flex align-center justify-center mt-4">
                        ...
                        <a className="text-xl m-1 p-1 sm:m-2 sm:p-2 text-blue-700 hover:bg-blue-500 rounded-full hover:text-white transition-colors duration-300" href="https://kaguwo.com/discord">
                            <FaDiscord />
                            <span className="sr-only">Discord</span>
                        </a>
                        <a className="text-xl mt-1 p-1 sm:m-2 sm:p-2 text-indigo-500 hover:bg-indigo-500 rounded-full hover:text-white transition-colors duration-300" href="https://twitter.com/alfredsaveron">
                            <FaRegPaperPlane />
